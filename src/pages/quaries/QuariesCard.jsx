...
const QuariesCard = ({interrogatory}) => {
  ...
  <div class="w-80 p-4 bg-white rounded-lg  transform hover:scale-105 transition-transform duration-300 ease-in-out shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)]  ">
  <img
