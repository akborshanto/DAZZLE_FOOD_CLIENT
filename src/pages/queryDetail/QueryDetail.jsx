      ...
      <div>
        <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
          <div className="lg:col-start-2">
            <h1 className="text-2xl font-bold tracking-tight sm:text-3xl font-lato">Query Title: {quaryTitle}</h1>
            <p className="mt-3 text-lg dark:text-gray-600">Brand Name:{pdBrand}</p>
            <div className="mt-12 space-y-12">
              <div className="flex">
                ...
                <div className="ml-4">
                  <h2 className="text-lg font-medium leading-6 dark:text-gray-900">Product Name:{pdName}</h2>
                  {/* ALTER NAtion Reasion */}
                  <h2 className="mt-2 dark:text-gray-600" > Alternation Reasion:{boycotReasonDetail}</h2>
                  <h2 bclassName="mt-2 dark:text-gray-600" > Date Posted:{currentTime}</h2>
                  <h2 bclassName="mt-2 dark:text-gray-600" > Reqomendation_Count:{recomendateCount}</h2>
...
<div className="max-w-md p-8 sm:flex sm:space-x-6 dark:bg-gray-50 dark:text-gray-800">
	<div className="flex-shrink-0 w-full mb-6 h-44 sm:h-32 sm:w-32 sm:mb-0">
		<img src={userImage} alt="" className="object-cover object-center w-full h-full rounded dark:bg-gray-500" />
	</div>
	<div className="flex flex-col space-y-4">
		...
		<div className="space-y-1">
			<span className="flex items-center space-x-2">
				...
				<span className="dark:text-gray-600">{userEmail}</span>
			</span>
...
<div className="mt-10 lg:mt-0 lg:col-start-1 lg:row-start-1">
  <img src={pdPhoto} alt="" className="mx-auto rounded-lg shadow-lg dark:bg-gray-500" />
</div>
