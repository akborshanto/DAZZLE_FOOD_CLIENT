  ...
  return (
    ...
    <section class="relative lg:min-h-[1000px] pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24">
        <div class="absolute inset-x-0 bottom-0 z-10 hidden lg:flex">
            <img class="hidden w-full lg:block" src="https://img.freepik.com/free-photo/delicious-burger-nature_23-2150902284.jpg?t=st=1715283496~exp=1715287096~hmac=c0a3e712e93c98cab1941fb152f76d046825ea643a82e31c82217af33b51dace&w=1060" alt="" />
        </div>
